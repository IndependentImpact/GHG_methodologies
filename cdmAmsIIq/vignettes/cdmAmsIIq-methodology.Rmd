...
knitr::kable(inputs$baseline_data, format = "html", digits = 2)
```
...
knitr::kable(walkthrough_results, format = "html", digits = 3)
```
...
knitr::kable(monitoring_summary, format = "html", digits = 2)
```
...
function_reference <- tibble::tibble(
  ...
  Purpose = c(
    "Aggregates baseline commercial building energy use into emissions and intensity diagnostics.",
    "Summarises post-retrofit grid energy emissions and energy intensity.",
    "Converts onsite energy supply into project emissions.",
    "Combines baseline, project, and leakage emissions to obtain net reductions.",
    "Meta-function chaining the AMS-II.Q equation helpers into a tidy workflow.",
