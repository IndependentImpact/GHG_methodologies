...
#' Check AMS-III.A technology type applicability (semantic)
#'
#' Validates that the project activity implements the required technology type,
#' as required by AMS-III.A condition (a). Uses SHACL validation against
#' the CDM concept scheme so any SKOS subtype of
#' `cdm:BiologicalNitrogenFixation` is accepted automatically.
#'
