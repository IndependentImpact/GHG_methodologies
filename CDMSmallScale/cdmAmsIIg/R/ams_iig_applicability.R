...
#' Check AMS-II.G energy efficiency technology applicability (semantic)
#'
#' Validates that the project activity implements an energy efficiency technology,
#' as required by AMS-II.G condition (a). Uses SHACL validation against the
...
#'   [read_ams_iig_technology_shapes()].
#'
#' @return A list with:
#' \describe{
...
#' Check AMS-II.G baseline fuel type applicability (semantic)
#'
#' Validates that the project baseline uses non-renewable biomass as the primary
#' fuel, as required by AMS-II.G condition (b).
#'
#' @param data Either a single character project IRI or a data frame with
