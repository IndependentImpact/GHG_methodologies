...
#' Check ACM0019 technology type applicability (semantic)
#'
...
#' `cdm:N2OAbatementTechnology` is accepted automatically.
#'
...
check_applicability_technology_type <- function(data,
  ...
  shapes          <- if (is.null(shapes)) read_acm0019_technology_shapes() else shapes
  ...
  cdmSemantic::cdm_make_applicability_result(result, data, "ACM0019", "N2OAbatementTechnology")
}
