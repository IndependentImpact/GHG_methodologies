...
#' Check ACM0008 technology type applicability (semantic)
#'
...
#' `cdm:CoalMineMethane` is accepted automatically.
#'
...
check_applicability_technology_type <- function(data,
  ...
  shapes          <- if (is.null(shapes)) read_acm0008_technology_shapes() else shapes
  ...
  cdmSemantic::cdm_make_applicability_result(result, data, "ACM0008", "CoalMineMethane")
}
