...
knitr::kable(head(emission_reductions), format = "html", digits = 4)
```
...
knitr::kable(head(period_summary), format = "html", digits = 4)
```
...
function_reference <- tibble::tibble(
  ...
  Purpose = c(
    ...
    "Applies project non-renewable fractions to monitored biomass use.",
    "Converts baseline non-renewable biomass into thermal energy.",
    "Converts project non-renewable biomass into thermal energy.",
    "Derives emissions from thermal energy using the relevant factors.",
    "Summarises leakage emissions associated with biomass supply chains.",
    "Computes net emission reductions from baseline, project, and leakage inputs.",
    "Aggregates monitoring data to reporting periods with derived quantities.",
    "Meta-function orchestrating the AMS-II.G equation helpers.",
