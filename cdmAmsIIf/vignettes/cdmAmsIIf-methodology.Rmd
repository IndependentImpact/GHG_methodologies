...
function_reference <- tibble::tibble(
  ...
  Purpose = c(
    "Aggregates baseline fossil fuel and electricity use into emissions.",
    "Summarises project energy use into comparable emission totals.",
    "Collects leakage emissions associated with agricultural interventions.",
    "Computes emission reductions from baseline, project, and leakage components.",
    "Rolls monitoring data to reporting periods for downstream analysis.",
    "Wrapper orchestrating the baseline, project, leakage, and reduction helpers.",
