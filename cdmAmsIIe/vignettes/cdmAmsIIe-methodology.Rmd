...
function_reference <- tibble::tibble(
  ...
  Purpose = c(
    "Aggregates baseline thermal and electricity energy into emissions.",
    "Summarises project thermal and electricity emissions after interventions.",
    "Collects leakage emissions associated with the building project activity.",
    "Combines baseline, project, and leakage totals to compute net reductions.",
    "Rolls monitoring data to the reporting periods for analysis.",
    "High-level wrapper orchestrating baseline, project, and leakage helpers.",
