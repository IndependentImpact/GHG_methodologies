...
function_reference <- tibble::tibble(
  ...
  Purpose = c(
    "Aggregates baseline energy consumption prior to efficiency upgrades.",
    "Summarises monitored project energy use for efficient technologies.",
    "Computes energy savings as the difference between baseline and project energy.",
    "Converts energy savings to emission reductions using emission factors.",
    "Rolls monitoring data to reporting periods with energy and emission summaries.",
    "High-level wrapper composing baseline, project, and reduction helpers.",
