...
function_reference <- tibble::tibble(
  ...
  Purpose = c(
    "Aggregates baseline fossil fuel use into emissions adjusted for system efficiency.",
    "Summarises project fossil emissions including auxiliary electricity where applicable.",
    "Collects leakage emissions associated with the efficiency intervention.",
    "Combines baseline, project, and leakage totals to compute net emission reductions.",
    "Rolls monitoring data up to reporting periods for downstream analysis.",
    "High-level wrapper orchestrating baseline, project, and leakage calculations.",
