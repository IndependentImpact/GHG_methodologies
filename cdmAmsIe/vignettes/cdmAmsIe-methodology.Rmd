...
function_reference <- tibble::tibble(
  ...
  Purpose = c(
    ...
    "Subtracts project emissions from baseline emissions to obtain reductions.",
    "Aggregates monitoring data by entity and reporting period.",
    "Chains the equation helpers into a tidyverse-friendly workflow.",
